...
## Corpus Check
- 17 files · ~80,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1122 nodes · 1917 edges · 123 communities (91 shown, 32 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- Frontend App Shell & Routing
- AppConfig, Env Parsing & Mailer
- AppState, API Doc & Server Bootstrap
- Listing Detail DTOs & Models
- Auth Service — Refresh, Logout & OTP
- Database Rules & Project Instructions (Agents)
- Frontend Listings API
- JWT & Hashing (crypto module)
...
- StorageProvider Trait & AppError Core
- Notification Templates Service
- Auth DTOs & Handler (OTP/Refresh)
- Users Repository & is_active Lookup
- AuthUser Extractor & Token Decoder
- MCP Server Config
- Auth Repository — Refresh Token Rotation
...
- AuthUser FromRequestParts Extractor
...
- RefreshTokenId Type Reference
- StorageProvider Type Reference
- String Type Reference
- Uuid Type Reference
- Json Type Reference
- State Type Reference
- AtomicUsize Type Reference
- Send Trait Bound
- Sync Trait Bound
...
### Community 2 - "AppState, API Doc & Server Bootstrap"
Cohesion: 0.08
Nodes (34): AppConfig, ApiDoc, AppServer, Error, Result, Self, shutdown_signal(), AppState (+26 more)
...
### Community 4 - "Auth Service — Refresh, Logout & OTP"
Cohesion: 0.15
Nodes (35): AtomicUsize, expired_token_is_rejected_without_family_revocation(), handle_revoked(), logout(), logout_revokes_only_the_single_current_token(), losing_the_rotate_race_falls_back_to_cached_replacement(), mint(), otp_request() (+27 more)

### Community 5 - "Database Rules & Project Instructions (Agents)"
Cohesion: 0.05
...
### Community 7 - "JWT & Hashing (crypto module)"
Cohesion: 0.12
Nodes (31): Algorithm, hash_otp_code(), hash_refresh_token(), hashes_deterministically_to_a_64_char_hex_digest(), String, sha256_hex(), Claims, encode_with_exp() (+23 more)
...
### Community 11 - "App Cache — OTP, Rate Limit & Refresh Replay"
Cohesion: 0.19
Nodes (15): AppCache, build_cache_provider(), build_otp_cache(), build_otp_rate_limit_cache(), build_refresh_replay_cache(), AppCacheProvider, Arc, RefreshTokenId (+7 more)

### Community 12 - "Listings Handler & Pagination"
Cohesion: 0.12
Nodes (23): get_by_id(), list(), Json, Path, Result, State, Uuid, PaginatedResponse (+15 more)

### Community 13 - "Frontend TS App Config"
Cohesion: 0.08
Nodes (23): compilerOptions, allowImportingTsExtensions, jsx, lib, module, moduleDetection, moduleResolution, noEmit (+15 more)

### Community 14 - "Backend/Frontend Code Review Skills & Invariants"
Cohesion: 0.11
...
### Community 15 - "CI Workflows & OpenAPI Type Generation"
Cohesion: 0.14
...
### Community 17 - "StorageProvider Trait & AppError Core"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (17): NotificationTemplate, OtpTemplate, OwnerRequestApprovedTemplate, OwnerRequestReceivedTemplate, OwnerRequestRejectedTemplate, render(), renders_otp_template_with_sample_context(), renders_owner_request_approved_template_with_sample_context() (+9 more)

### Community 19 - "Auth DTOs & Handler (OTP/Refresh)"
Cohesion: 0.25
Nodes (15): AuthUser, OtpRequestDto, OtpRequestMessageDto, OtpRequestResponse, RefreshResponse, RefreshTokenDto, String, logout() (+7 more)

### Community 20 - "Users Repository & is_active Lookup"
Cohesion: 0.15
Nodes (14): find_is_active(), Option, PgPool, Result, Uuid, IsActiveLookup, PgIsActiveLookup, AtomicUsize (+6 more)

### Community 21 - "AuthUser Extractor & Token Decoder"
Cohesion: 0.28
Nodes (13): active_user_resolves_identity(), cache_hit_skips_the_db_lookup(), cache_miss_falls_through_to_db_and_repopulates_cache(), claims(), inactive_user_is_rejected_even_with_valid_token(), malformed_token_is_unauthorized(), resolve_identity(), StubDecoder (+5 more)
...
### Community 23 - "Auth Repository — Refresh Token Rotation"
Cohesion: 0.35
Nodes (13): db_err(), email_exists(), find_by_hash(), revoke(), revoke_all_for_user(), rotate(), AppError, Error (+5 more)

### Community 24 - "AppError Centralized Type"
Cohesion: 0.24
...
### Community 25 - "Storage Key Generation"
Cohesion: 0.25
...
### Community 26 - "Architecture Doc — Core Flows & Modules"
Cohesion: 0.29
...
### Community 27 - "Project CLAUDE.md Instructions"
Cohesion: 0.17
...
### Community 28 - "Auth Model & RBAC"
Cohesion: 0.21
Nodes (6): RefreshTokenLookup, Uuid, failed_check_maps_to_forbidden(), require_role(), Role, Result

### Community 29 - "Graphify Extraction Spec"
Cohesion: 0.18
...
### Community 30 - "Technical Spec — DB Triggers & Contact Endpoint"
Cohesion: 0.26
...
### Community 32 - "AuthUser FromRequestParts Extractor"
Cohesion: 0.27
Nodes (8): AuthUser, bearer_token(), Result, Self, FromRequestParts, Parts, Rejection, S

### Community 33 - "Graphify Export Steps (Wiki/Neo4j/FalkorDB/SVG/GraphML)"
Cohesion: 0.18
...
### Community 34 - "No-Proxy & Owner Request Docs Flow"
Cohesion: 0.18
...
### Community 40 - "Graphify Video Transcription Step"
Cohesion: 0.29
...
### Community 41 - "OTP Auth Flow & ADR"
Cohesion: 0.25
...
### Community 42 - "AppCacheProvider & AuthState"
Cohesion: 0.29
Nodes (6): AppCacheProvider, Send, Sync, AuthState, Arc, FromRef

### Community 43 - "MokaStore Generic Methods"
Cohesion: 0.52
Nodes (4): MokaStore<K, V>, K, Option, V

### Community 44 - "Graphify Add/Watch Ingest"
Cohesion: 0.29
...
### Community 45 - "Graphify Multi-Repo Merge Flow"
Cohesion: 0.29
...
### Community 46 - "Storage ADR & Owner Requests"
Cohesion: 0.29
...
### Community 47 - "README Skill (embeds duplicated React/TS rules)"
Cohesion: 0.40
...
### Community 48 - "Graphify Update/Cluster-Only Subcommands"
Cohesion: 0.40
...
### Community 49 - "Listing Management Wireframes"
Cohesion: 0.33
...
### Community 50 - "Database Connection Pool"
Cohesion: 0.50
Nodes (4): connect_db(), Error, PgPool, Result

### Community 51 - "Graphify Manifest & Honesty Rules"
Cohesion: 0.40
...
### Community 52 - "Graphify Build Pipeline Steps"
Cohesion: 0.40
...
### Community 53 - "Graphify Codex Multi-Agent Spawn"
Cohesion: 0.50
...
### Community 54 - "OTP Code Generation"
Cohesion: 0.67
Nodes (3): generate_otp_code(), generated_code_is_always_six_digits(), String

### Community 55 - "Graphify CLAUDE.md/Hook Integration"
Cohesion: 0.50
...
### Community 56 - "CI Security Workflows (CodeQL/Gitleaks)"
Cohesion: 0.50
...
### Community 61 - "README & Git Conventions"
Cohesion: 0.67
...
- **What is the exact relationship between `README Writing Rules Skill` and `Embedded React/TypeScript Rules Content`?**
  _Edge tagged AMBIGUOUS (relation: shares_data_with) - confidence is low._
- **Why does `AppError` connect `StorageProvider Trait & AppError Core` to `AuthUser FromRequestParts Extractor`, `Listing Detail DTOs & Models`, `LocalFsStorage Implementation`, `Listings Handler & Pagination`, `Users Repository & is_active Lookup`, `AuthUser Extractor & Token Decoder`, `AppError Centralized Type`, `Auth Model & RBAC`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `AppState` connect `AppState, API Doc & Server Bootstrap` to `AuthUser FromRequestParts Extractor`, `AppCacheProvider & AuthState`, `Listings Handler & Pagination`, `Auth DTOs & Handler (OTP/Refresh)`, `AuthUser Extractor & Token Decoder`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `build_cache_provider()` connect `App Cache — OTP, Rate Limit & Refresh Replay` to `AuthUser Extractor & Token Decoder`?**
