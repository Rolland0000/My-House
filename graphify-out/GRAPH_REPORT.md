...
- Users Repository — Admin Bootstrap & is_active Lookup
- Docker Rules Skill
...
- TypeScript ESLint Dependency Pair
...
1. `AppError` - 92 edges
2. `AppState` - 34 edges
3. `AppCacheProvider` - 31 edges
4. `cn()` - 27 edges
5. `AppConfig` - 20 edges
6. `set_valid_env()` - 20 edges
7. `Mailer` - 20 edges
8. `perform_verify_otp()` - 20 edges
9. `Role` - 20 edges
...
### Community 0 - "Auth Model & Repository — Seeker Creation"
Cohesion: 0.07
...
### Community 1 - "JWT Crypto & AuthUser Extractor"
Cohesion: 0.07
...
### Community 2 - "ApiDoc & App Server Bootstrap"
Cohesion: 0.06
Nodes (48): ApiDoc, AppServer, Error, Result, Self, SocketAddr, shutdown_signal(), AppState (+40 more)

### Community 3 - "AppConfig — Admin Bootstrap & Rate Limit & CORS"
Cohesion: 0.09
...
### Community 4 - "Listing Detail DTOs & Models"
Cohesion: 0.09
...
### Community 5 - "Frontend Shared UI Components (Alert/Button/Card)"
Cohesion: 0.10
Nodes (34): Alert(), AlertProps, AlertVariant, variantConfig, Button(), ButtonProps, ButtonSize, ButtonVariant (+26 more)

### Community 6 - "Database Rules & Project Instructions (Agents)"
Cohesion: 0.05
...
### Community 7 - "App Cache — OTP, IP Rate Limit & Refresh Replay"
Cohesion: 0.13
Nodes (23): AppCache, build_cache_provider(), build_ip_rate_limit_cache(), build_otp_cache(), build_otp_rate_limit_cache(), build_refresh_replay_cache(), Arc, AtomicU32 (+15 more)

### Community 8 - "Mailer & Notification Service"
Cohesion: 0.09
...
### Community 9 - "IP Rate Limit Middleware"
Cohesion: 0.14
...
### Community 10 - "LocalFsStorage Implementation"
Cohesion: 0.17
...
### Community 11 - "Frontend Listings API"
Cohesion: 0.18
...
### Community 18 - "AppError & Errors Module"
Cohesion: 0.18
Nodes (14): ErrorBody, ErrorEnvelope, parse_envelope(), Error, Response, Self, StatusCode, String (+6 more)
...
### Community 20 - "Storage Key Generation"
Cohesion: 0.25
...
### Community 26 - "Frontend Runtime Dependencies"
Cohesion: 0.15
...
### Community 28 - "Frontend NPM Scripts"
Cohesion: 0.17
...
### Community 30 - "Graphify Export Steps (Wiki/Neo4j/FalkorDB/SVG/GraphML)"
Cohesion: 0.18
...
### Community 31 - "No-Proxy & Owner Request Docs Flow"
Cohesion: 0.18
...
### Community 32 - "Graphify Query/Path/Explain Flow"
Cohesion: 0.24
...
### Community 33 - "Design Tokens & Listings Endpoints"
Cohesion: 0.20
...
### Community 34 - "Docker Compose Services (Dev)"
Cohesion: 0.25
...
### Community 41 - "Frontend package.json Metadata"
Cohesion: 0.25
Nodes (7): name, typescript, overrides, openapi-typescript, private, type, version

### Community 42 - "Frontend API Client (fetch wrapper)"
Cohesion: 0.32
...
### Community 46 - "Graphify Multi-Repo Merge Flow"
Cohesion: 0.29
...
### Community 47 - "Storage ADR & Owner Requests"
Cohesion: 0.29
...
### Community 48 - "Frontend Pagination Component & Utils"
Cohesion: 0.38
Nodes (4): Pagination(), PaginationProps, getPageItems(), PageItem

### Community 49 - "README Skill (embeds duplicated React/TS rules)"
Cohesion: 0.40
...
### Community 50 - "Graphify Update/Cluster-Only Subcommands"
Cohesion: 0.40
...
### Community 51 - "Listing Management Wireframes"
Cohesion: 0.33
...
### Community 52 - "Database Connection Pool"
Cohesion: 0.50
Nodes (4): connect_db(), Error, PgPool, Result

### Community 53 - "Graphify Manifest & Honesty Rules"
Cohesion: 0.40
...
### Community 54 - "Graphify Build Pipeline Steps"
Cohesion: 0.40
...
### Community 55 - "Graphify Codex Multi-Agent Spawn"
Cohesion: 0.50
...
### Community 56 - "OTP Code Generation"
Cohesion: 0.67
Nodes (3): generate_otp_code(), generated_code_is_always_six_digits(), String

### Community 57 - "Graphify CLAUDE.md/Hook Integration"
Cohesion: 0.50
...
### Community 58 - "CI Security Workflows (CodeQL/Gitleaks)"
Cohesion: 0.50
...
### Community 63 - "README & Git Conventions"
Cohesion: 0.67
...
- **What is the exact relationship between `README Writing Rules Skill` and `Embedded React/TypeScript Rules Content`?**
  _Edge tagged AMBIGUOUS (relation: shares_data_with) - confidence is low._
- **Why does `AppError` connect `Auth Model & Repository — Seeker Creation` to `JWT Crypto & AuthUser Extractor`, `ApiDoc & App Server Bootstrap`, `AppConfig — Admin Bootstrap & Rate Limit & CORS`, `Listing Detail DTOs & Models`, `Users Repository — Admin Bootstrap & is_active Lookup`, `Mailer & Notification Service`, `LocalFsStorage Implementation`, `Listings Handler & Pagination`, `AppError & Errors Module`, `StorageProvider Trait Core`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `AppConfig` connect `AppConfig — Admin Bootstrap & Rate Limit & CORS` to `Mailer & Notification Service`, `ApiDoc & App Server Bootstrap`, `App Cache — OTP, IP Rate Limit & Refresh Replay`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `AppCacheProvider` connect `App Cache — OTP, IP Rate Limit & Refresh Replay` to `Auth Model & Repository — Seeker Creation`, `IP Rate Limit Middleware`, `MokaStore Generic Methods`, `JWT Crypto & AuthUser Extractor`?**
