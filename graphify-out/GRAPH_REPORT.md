...
## Corpus Check
- 190 files · ~83,585 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1171 nodes · 2225 edges · 110 communities (88 shown, 22 thin omitted)
...
- AppConfig, Env Parsing & CORS Middleware
...
### Community 2 - "JWT & Hashing (crypto module)"
Cohesion: 0.06
Nodes (60): Algorithm, hash_otp_code(), hash_refresh_token(), hashes_deterministically_to_a_64_char_hex_digest(), String, sha256_hex(), Claims, encode_with_exp() (+52 more)

### Community 3 - "ApiDoc & App Server Bootstrap"
Cohesion: 0.06
...
### Community 5 - "AppConfig, Env Parsing & CORS Middleware"
Cohesion: 0.12
Nodes (39): app_port_defaults_to_3000_when_absent(), AppConfig, AppEnv, ConfigError, empty_trusted_proxies_trusts_nothing(), loads_valid_config(), optional_or(), optional_u16_or() (+31 more)
...
### Community 8 - "Frontend Listings API"
Cohesion: 0.14
...
### Community 9 - "Mailer & Notification Service"
Cohesion: 0.09
...
### Community 10 - "IP Rate Limit Middleware"
Cohesion: 0.14
...
### Community 11 - "LocalFsStorage Implementation"
Cohesion: 0.17
...
### Community 26 - "Technical Spec — DB Triggers & Contact Endpoint"
Cohesion: 0.26
...
### Community 29 - "Graphify Export Steps (Wiki/Neo4j/FalkorDB/SVG/GraphML)"
Cohesion: 0.18
...
### Community 30 - "No-Proxy & Owner Request Docs Flow"
Cohesion: 0.18
...
### Community 31 - "Graphify Query/Path/Explain Flow"
Cohesion: 0.24
...
### Community 32 - "Design Tokens & Listings Endpoints"
Cohesion: 0.20
...
### Community 33 - "Docker Compose Services (Dev)"
Cohesion: 0.25
...
### Community 34 - "MokaStore Implementation"
Cohesion: 0.25
Nodes (7): MokaStore, MokaStore<K, V>, Duration, K, Self, V, Cache

### Community 35 - "Docker Rules Skill"
Cohesion: 0.25
...
### Community 38 - "Frontend package.json Metadata"
Cohesion: 0.25
Nodes (7): name, typescript, overrides, openapi-typescript, private, type, version

### Community 39 - "MokaStore Generic Methods"
Cohesion: 0.52
Nodes (4): MokaStore<K, V>, K, Option, V

### Community 40 - "Graphify Add/Watch Ingest"
Cohesion: 0.29
...
### Community 41 - "Graphify Multi-Repo Merge Flow"
Cohesion: 0.29
...
### Community 42 - "Storage ADR & Owner Requests"
Cohesion: 0.29
...
### Community 43 - "Users Repository — is_active Lookup"
Cohesion: 0.47
Nodes (5): find_is_active(), Option, PgPool, Result, Uuid

### Community 44 - "README Skill (embeds duplicated React/TS rules)"
Cohesion: 0.40
...
### Community 45 - "Graphify Update/Cluster-Only Subcommands"
Cohesion: 0.40
...
### Community 46 - "Listing Management Wireframes"
Cohesion: 0.33
...
### Community 47 - "Database Connection Pool"
Cohesion: 0.50
Nodes (4): connect_db(), Error, PgPool, Result

### Community 48 - "Graphify Manifest & Honesty Rules"
Cohesion: 0.40
...
### Community 49 - "Graphify Build Pipeline Steps"
Cohesion: 0.40
...
### Community 50 - "Graphify Codex Multi-Agent Spawn"
Cohesion: 0.50
...
### Community 51 - "OTP Code Generation"
Cohesion: 0.67
...
- **What is the exact relationship between `README Writing Rules Skill` and `Embedded React/TypeScript Rules Content`?**
  _Edge tagged AMBIGUOUS (relation: shares_data_with) - confidence is low._
- **Why does `AppError` connect `Auth Model & Repository — Seeker Creation` to `JWT & Hashing (crypto module)`, `ApiDoc & App Server Bootstrap`, `Listing Detail DTOs & Models`, `Mailer & Notification Service`, `LocalFsStorage Implementation`, `Listings Handler & Pagination`, `Users Repository — is_active Lookup`, `AppError & Errors Module`, `StorageProvider Trait Core`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `AppState` connect `ApiDoc & App Server Bootstrap` to `JWT & Hashing (crypto module)`, `Listings Handler & Pagination`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `AppConfig` connect `AppConfig, Env Parsing & CORS Middleware` to `Mailer & Notification Service`, `ApiDoc & App Server Bootstrap`, `App Cache — OTP, Rate Limit & Refresh Replay`?**
